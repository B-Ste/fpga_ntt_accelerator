...
XSIM_DIR="$SCRIPT_DIR/../../../project_ntt_accelerator/project_ntt_accelerator.sim/sim_intt_processor_tb/behav/xsim"

# Step 1: Run the executable and supply inputs 8 and 0
echo "Running ntt_bench_bar with inputs 10 and $Q..."
